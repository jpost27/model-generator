...
public class Statistic {
    ...
    public Optional<Integer> getIntYards() {
        return Optional.ofNullable(intYards);
    }
    ...
    public Optional<Integer> getLost() {
    ...
    public Optional<Integer> getIntTouchdown() {
        return Optional.ofNullable(intTouchdown);
    }
