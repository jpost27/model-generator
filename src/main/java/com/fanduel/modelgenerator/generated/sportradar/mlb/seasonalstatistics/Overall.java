...
public class Overall {
    ...
    @JsonProperty("era_minus")
    private Double eraMinus;
    ...
    public Optional<Double> getFip() {
        return Optional.ofNullable(fip);
    }
    ...
    public Optional<Double> getXfip() {
        return Optional.ofNullable(xfip);
    }

    public Optional<Double> getEraMinus() {
        return Optional.ofNullable(eraMinus);
    }
