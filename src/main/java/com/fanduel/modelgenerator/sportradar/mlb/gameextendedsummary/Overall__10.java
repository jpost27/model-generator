...
public class Overall__10 {
    ...
    @JsonProperty("onbase")
    public Onbase__17 onbase;
    @JsonProperty("runs")
    public Runs__17 runs;
    @JsonProperty("outcome")
    public Outcome__17 outcome;
    @JsonProperty("outs")
    public Outs__17 outs;
    @JsonProperty("steal")
    public Steal__22 steal;
    @JsonProperty("pitches")
    public Pitches__17 pitches;
    @JsonProperty("in_play")
    public InPlay__11 inPlay;
    @JsonProperty("games")
    public Games__18 games;
