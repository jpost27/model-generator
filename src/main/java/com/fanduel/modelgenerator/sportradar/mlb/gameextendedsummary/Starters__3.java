...
public class Starters__3 {
    ...
    @JsonProperty("onbase")
    public Onbase__19 onbase;
    @JsonProperty("runs")
    public Runs__19 runs;
    @JsonProperty("outcome")
    public Outcome__19 outcome;
    @JsonProperty("outs")
    public Outs__19 outs;
    @JsonProperty("steal")
    public Steal__24 steal;
    @JsonProperty("pitches")
    public Pitches__19 pitches;
    @JsonProperty("in_play")
    public InPlay__13 inPlay;
    @JsonProperty("games")
    public Games__20 games;
