...
public class Seasontd__4 {
    ...
    @JsonProperty("onbase")
    public Onbase__16 onbase;
    @JsonProperty("runs")
    public Runs__16 runs;
    @JsonProperty("outcome")
    public Outcome__16 outcome;
    @JsonProperty("outs")
    public Outs__16 outs;
    @JsonProperty("steal")
    public Steal__21 steal;
    @JsonProperty("pitches")
    public Pitches__16 pitches;
    @JsonProperty("in_play")
    public InPlay__10 inPlay;
    @JsonProperty("games")
