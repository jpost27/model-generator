...
public class Bullpen__3 {
    ...
    @JsonProperty("onbase")
    public Onbase__18 onbase;
    @JsonProperty("runs")
    public Runs__18 runs;
    @JsonProperty("outcome")
    public Outcome__18 outcome;
    @JsonProperty("outs")
    public Outs__18 outs;
    @JsonProperty("steal")
    public Steal__23 steal;
    @JsonProperty("pitches")
    public Pitches__18 pitches;
    @JsonProperty("in_play")
    public InPlay__12 inPlay;
    @JsonProperty("games")
    public Games__19 games;
