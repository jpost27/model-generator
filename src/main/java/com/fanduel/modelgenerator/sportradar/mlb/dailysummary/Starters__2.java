...
public class Starters__2 {
    ...
    public Double obp;
    @JsonProperty("onbase")
    public Onbase__10 onbase;
    @JsonProperty("runs")
    public Runs__10 runs;
    @JsonProperty("outcome")
    public Outcome__10 outcome;
    @JsonProperty("outs")
    public Outs__10 outs;
    @JsonProperty("steal")
    public Steal__13 steal;
    @JsonProperty("pitches")
    public Pitches__10 pitches;
    @JsonProperty("in_play")
    public InPlay__7 inPlay;
    @JsonProperty("games")
