package com.fanduel.modelgenerator.generated.nbav8.splitshierarchy;
...
public class Total {
    ...
    @JsonProperty("technical_other")
    private Integer technicalOther;

    @JsonProperty("field_goals_att")
    private Integer fieldGoalsAtt;

    @JsonProperty("tech_fouls_non_unsportsmanlike")
    private Integer techFoulsNonUnsportsmanlike;
    ...
    private Integer defensiveAssists;
    ...
    public Optional<Integer> getTotalTurnovers() {
        return Optional.ofNullable(totalTurnovers);
    }
    ...
    public Optional<Integer> getDoubleDoubles() {
        return Optional.ofNullable(doubleDoubles);
    }
    ...
    public Optional<Integer> getEjections() {
        return Optional.ofNullable(ejections);
    }
    ...
    public Optional<Integer> getTechnicalOther() {
        return Optional.ofNullable(technicalOther);
    }
    ...
    public Optional<Integer> getTechFoulsNonUnsportsmanlike() {
        return Optional.ofNullable(techFoulsNonUnsportsmanlike);
    }
    ...
    public Optional<Integer> getTripleDoubles() {
        return Optional.ofNullable(tripleDoubles);
    }

    public Optional<Integer> getDefensiveAssists() {
        return Optional.ofNullable(defensiveAssists);
    }
    ...
    public Optional<Integer> getFoulouts() {
        return Optional.ofNullable(foulouts);
    }
    ...
    public Optional<Integer> getCoachEjections() {
        return Optional.ofNullable(coachEjections);
    }
